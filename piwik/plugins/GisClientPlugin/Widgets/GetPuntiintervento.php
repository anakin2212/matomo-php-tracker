 ...
 */
class GetPuntiintervento extends Widget
{
    ...
    public static function configure(WidgetConfig $config)
    {
         ...
         * your own category.
         */
        $config->setCategoryId('GisClientPlugin_GisClient');
    ...
    public function render()
    {
       ...
       $html .= '<iframe width="100%" height="500px" src="https://geoweb-dev.master.local/gisclient3/services/plugins/matomo/registerMapRequestPoint.php?action=view'
             .(!empty($passingParams) ? '&'.http_build_query($passingParams) : '').'"></iframe>';
        return $html;
    }
